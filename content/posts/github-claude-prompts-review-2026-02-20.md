+++
date = "2026-02-20T22:08:20+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-02-20"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 66019 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均66019个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 115332 | **🍴 Forks:** 29725 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 48741 | **🍴 Forks:** 6048 | **📅 创建时间:** 2026-01-18
...
- **2026-02-20** by Affaan Mustafa: chore: update Sonnet model references from 4.5 to 4.6

chore: update Sonnet model references from 4.
- **2026-02-20** by Affaan Mustafa: fix: CI/Test for issue #226 (hook override bug)

Fixed CI / Test for (issue#226)
- **2026-02-20** by yptse123: chore: update Sonnet model references from 4.5 to 4.6

Update MODEL_SONNET constant and all document

---

## 3. LibreChat

**⭐ GitHub Stars:** 33986 | **🍴 Forks:** 6844 | **📅 创建时间:** 2023-02-12
...
- **2026-02-20** by Danny Avila: 🔍 chore: Update MeiliSearch version (#11873)

- Bumped MeiliSearch image version from v1.12.3 to v1.
- **2026-02-19** by Danny Avila: 📝 docs: Add AGENTS.md for Project Structure and Coding Standards (#11866)

* 📝 docs: Add AGENTS.md f
- **2026-02-19** by Danny Avila: ✨ v0.8.3-rc1 (#11856)

* 🔧 chore: Update configuration version to 1.3.4 in librechat.example.yaml an
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-02-20 22:08:20*
