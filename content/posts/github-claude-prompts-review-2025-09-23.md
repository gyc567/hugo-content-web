+++
date = "2025-09-23T22:06:21+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2025-09-23"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 42724 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均42724个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 87564 | **🍴 Forks:** 24001 | **📅 创建时间:** 2025-03-05
...
- **2025-09-17** by Lucas Valbuena: Update README.md
- **2025-09-17** by Lucas Valbuena: Merge pull request #236 from paulacavero/main

Update README.md
- **2025-09-17** by Paula Cavero: Update README.md

---

## 2. CL4R1T4S

**⭐ GitHub Stars:** 10328 | **🍴 Forks:** 2113 | **📅 创建时间:** 2025-03-04
...
**⭐ GitHub Stars:** 30281 | **🍴 Forks:** 5759 | **📅 创建时间:** 2023-02-12
...
- **2025-09-23** by Danny Avila: 🆔 fix: Prioritize Immutable Sub Claim for OIDC User ID (#9788)

* add use of immutable claims to ide
- **2025-09-23** by MyGitHub: 🌐 feat: Helm DNS Configuration Support for Traffic Redirection (#9785)

This PR adds DNS configurati
- **2025-09-23** by Ihsan Soydemir: 🔐 feat: Support Multiple Roles in `OPENID_REQUIRED_ROLE` (#9171)

* feat: support multiple roles in 
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2025-09-23 22:06:21*
