+++
date = "2026-02-28T22:07:18+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-02-28"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 71808 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均71808个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 126421 | **🍴 Forks:** 32391 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 54794 | **🍴 Forks:** 6759 | **📅 创建时间:** 2026-01-18
...
- **2026-02-28** by Affaan Mustafa: docs: update positioning to performance optimization system, add Plankton reference
- **2026-02-28** by Affaan Mustafa: feat: add exa-web-search to MCP config template
- **2026-02-28** by Affaan Mustafa: feat: expand research-first mandate in development workflow

---

## 3. LibreChat

**⭐ GitHub Stars:** 34211 | **🍴 Forks:** 6908 | **📅 创建时间:** 2023-02-12
...
- **2026-02-28** by Daniel Lew: 👁️‍🗨️ fix: Replace Select with Menu in AccountSettings for Screen Reader Accuracy (#11980)

AccountS
- **2026-02-28** by Danny Avila: 🎚️ feat: Add Thinking Level Parameter for Gemini 3+ Models (#11994)

* 🧠 feat: Add Thinking Level Co
- **2026-02-28** by Danny Avila: 🔀 feat: update OpenRouter with new Reasoning config (#11993)

* fix: Update OpenRouter reasoning han
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-02-28 22:07:18*
