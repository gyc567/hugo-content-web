+++
date = "2026-02-12T22:11:45+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-02-12"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 64395 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均64395个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 114344 | **🍴 Forks:** 29582 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 45009 | **🍴 Forks:** 5577 | **📅 创建时间:** 2026-01-18
...
- **2026-02-12** by Affaan Mustafa: docs: expand AgentShield section with hackathon context and add sponsors

- Expand AgentShield ecosy
- **2026-02-12** by Affaan Mustafa: feat: add TypeScript declaration files for all core libraries

Add .d.ts type definitions for all fo
- **2026-02-12** by Affaan Mustafa: chore: rename opencode plugin to ecc-universal and add .npmignore

- Rename opencode-ecc to ecc-univ

---

## 3. LibreChat

**⭐ GitHub Stars:** 33832 | **🍴 Forks:** 6795 | **📅 创建时间:** 2023-02-12
...
- **2026-02-12** by Dustin Healy: 💡 fix: System Theme Picker Selection (#11220)

* fix: theme picker selection

* refactor: remove pro
- **2026-02-12** by Danny Avila: 🗃️ refactor: Separate Tool Cache Namespace for Blue/Green Deployments (#11738)

* 🔧 refactor: Introd
- **2026-02-12** by ethanlaj: 🕵️‍♂️ fix: Handle 404 errors on agent queries for favorites (#11587)
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-02-12 22:11:45*
