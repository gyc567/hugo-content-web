+++
date = "2026-03-20T22:09:11+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-03-20"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 85903 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均85903个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 132395 | **🍴 Forks:** 33513 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 90501 | **🍴 Forks:** 11869 | **📅 创建时间:** 2026-01-18
...
- **2026-03-20** by Affaan Mustafa: fix: skip flaky observer shell test on Windows (#722)
- **2026-03-20** by Affaan Mustafa: fix: update catalog counts for flutter-reviewer (28 agents, 116 skills)
- **2026-03-20** by Maciej: feat(agents): add flutter-reviewer agent and skill (#716)

Library-agnostic Flutter/Dart code review

---

## 3. LibreChat

**⭐ GitHub Stars:** 34814 | **🍴 Forks:** 7047 | **📅 创建时间:** 2023-02-12
...
- **2026-03-20** by Danny Avila: ✨ v0.8.4 (#12339)

* 🔖 chore: Bump version to v0.8.4

- App version: v0.8.4-rc1 → v0.8.4
- @librecha
- **2026-03-20** by Danny Avila: 🛂 fix: Gate MCP Queries Behind USE Permission to Prevent 403 Spam (#12345)

* 🐛 fix: Gate MCP querie
- **2026-03-20** by Danny Avila: 🩺 refactor: Surface Descriptive OCR Error Messages to Client (#12344)

* fix: pass along error messa
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-03-20 22:09:11*
