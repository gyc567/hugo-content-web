+++
date = "2025-09-30T22:06:57+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2025-09-30"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 43362 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均43362个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 88973 | **🍴 Forks:** 24302 | **📅 创建时间:** 2025-03-05
...
- **2025-09-30** by Lucas Valbuena: Update README.md
- **2025-09-30** by Lucas Valbuena: Merge pull request #230 from ghuntley/ampcode

add Amp (ampcode.com) prompts for Sonnet and GPT-5
- **2025-09-29** by Lucas Valbuena: Create Claude Code 2.0.txt

---

## 2. CL4R1T4S

**⭐ GitHub Stars:** 10637 | **🍴 Forks:** 2173 | **📅 创建时间:** 2025-03-04
...
**⭐ GitHub Stars:** 30476 | **🍴 Forks:** 5830 | **📅 创建时间:** 2023-02-12
...
- **2025-09-30** by Danny Avila: Revert "🚉 feat: MCP Registry Individual Server Init (#9887)"

This reverts commit b8720a9b7ab0c76d45
- **2025-09-30** by normunds-wipo: 📂 fix: Allow `text/xml` mimetype (#9908)
- **2025-09-30** by Federico Ruggi: 🔧 fix: Ensure `getServerToolFunctions` Handles Errors (#9895)

* ensure getServerToolFunctions handl
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2025-09-30 22:06:57*
