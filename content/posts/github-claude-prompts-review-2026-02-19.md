+++
date = "2026-02-19T22:10:50+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-02-19"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 65840 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均65840个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 115216 | **🍴 Forks:** 29700 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 48355 | **🍴 Forks:** 5979 | **📅 创建时间:** 2026-01-18
...
- **2026-02-19** by Affaan Mustafa: Merge pull request #251 from gangqian68/main

docs: add CLAUDE.md for Claude Code guidance
- **2026-02-19** by qian gang: docs: add CLAUDE.md for Claude Code guidance

Add project-level CLAUDE.md with test commands, archit
- **2026-02-17** by Affaan Mustafa: chore: update skill count from 37 to 43, add 5 new skills to directory listing
...
**⭐ GitHub Stars:** 33950 | **🍴 Forks:** 6838 | **📅 创建时间:** 2023-02-12
...
- **2026-02-18** by Danny Avila: 🧬 fix: Backfill Missing SHARE Permissions and Migrate Legacy SHARED_GLOBAL Fields (#11854)
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-02-19 22:10:50*
