+++
date = "2026-02-11T22:11:41+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-02-11"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 64079 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均64079个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 114221 | **🍴 Forks:** 29558 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 44205 | **🍴 Forks:** 5479 | **📅 创建时间:** 2026-01-18
...
- **2026-02-11** by Affaan Mustafa: Merge pull request #183 from moonlandar/feat/cpp-testing-skill

Feat/cpp testing skill
- **2026-02-11** by Affaan Mustafa: Merge pull request #189 from zdocapp/upstreawm/fix-markdownlint-error

fix: resolve markdownlint iss
- **2026-02-11** by Affaan Mustafa: Merge pull request #190 from JackyST0/patch-1
...
**⭐ GitHub Stars:** 33812 | **🍴 Forks:** 6787 | **📅 创建时间:** 2023-02-12
...
- **2026-02-11** by Danny Avila: 📦 chore: Bump `@librechat/agents` & `axios`, Bedrock Prompt Caching fix (#11723)

* 🔧 chore: Update 
- **2026-02-10** by Danny Avila: 🔧 fix: Update z-index for ImagePreview modal components (#11714)

- Increased z-index values for the
- **2026-02-10** by Sean DMR: 🪟 fix: Update Link Target to Open in Separate Tabs (#11669)

`_new` is not a recognized keyword for 
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-02-11 22:11:41*
