+++
date = "2026-02-21T22:07:24+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-02-21"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 66206 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均66206个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 115551 | **🍴 Forks:** 29790 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 49054 | **🍴 Forks:** 6085 | **📅 创建时间:** 2026-01-18
...
- **2026-02-21** by Tatsuya Shimomoto: feat(commands): add learn-eval command

---

## 3. LibreChat

**⭐ GitHub Stars:** 34015 | **🍴 Forks:** 6852 | **📅 创建时间:** 2023-02-12
...
- **2026-02-20** by Danny Avila: ✳️ docs: Point CLAUDE.md to AGENTS.md (#11886)
- **2026-02-20** by Danny Avila: 🤖 feat: Gemini 3.1 Pricing and Context Window (#11884)

- Added support for the new Gemini 3.1 model
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-02-21 22:07:24*
