+++
date = "2026-01-28T22:10:02+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-01-28"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 59547 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均59547个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 111628 | **🍴 Forks:** 29125 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 33578 | **🍴 Forks:** 4086 | **📅 创建时间:** 2026-01-18
...
![Shell](https://img.shields.io/badge/-Shell-4E...
```

### 最近更新

- **2026-01-27** by Affaan Mustafa: docs: update README with skill-create and instinct commands
- **2026-01-27** by Affaan Mustafa: feat: add skill-create and continuous-learning-v2 commands

New commands:
- /skill-create: Local git
- **2026-01-27** by Affaan Mustafa: Merge pull request #91 from Hor1zonZzz/fix/readme-rules-limitation

docs: add note about rules limit

---

## 3. LibreChat

**⭐ GitHub Stars:** 33437 | **🍴 Forks:** 6690 | **📅 创建时间:** 2023-02-12
...
- **2026-01-28** by Dustin Healy: 🔗 feat: More Accessible Link Behaviors and Minor UI Improvements (#11549)

* fix: accessibility issu
- **2026-01-28** by Danny Avila: 🧹 refactor: Remove context-1m header filtering from Vertex Endpoint (#11551)

* Removed the filterin
- **2026-01-28** by github-actions[bot]: 🌍 i18n: Update translation.json with latest translations (#11546)
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-01-28 22:10:02*
