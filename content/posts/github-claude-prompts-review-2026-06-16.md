+++
date = "2026-06-16T22:42:31+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-06-16"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 141849 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均141849个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 216689 | **🍴 Forks:** 33286 | **📅 创建时间:** 2026-01-18
...
- **2026-06-16** by Affaan Mustafa: docs: use Atlas Cloud GitHub sponsor avatar
- **2026-06-16** by Affaan Mustafa: docs: use Atlas Cloud site logo
- **2026-06-16** by Affaan Mustafa: docs: add Atlas Cloud sponsor placement

---

## 2. system-prompts-and-models-of-ai-tools

**⭐ GitHub Stars:** 140676 | **🍴 Forks:** 34701 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 68182 | **🍴 Forks:** 6892 | **📅 创建时间:** 2026-04-03
...
- **2026-06-16** by Safi: Unify query skill: ship expansion + inline fallback to every platform

The query skill was split acr
- **2026-06-16** by Safi: Resolve cross-file Java type references by import package

Same-named types in different packages le
- **2026-06-16** by Safi: Collapse Swift module imports to one shared node

Adopts the approach from #1330 (thanks @duncan-day
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-06-16 22:42:31*
