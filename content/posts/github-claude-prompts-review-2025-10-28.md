+++
date = "2025-10-28T22:06:42+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2025-10-28"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 47943 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均47943个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 93492 | **🍴 Forks:** 25259 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 31114 | **🍴 Forks:** 6029 | **📅 创建时间:** 2023-02-12
...
- **2025-10-28** by Danny Avila: 🔄 refactor: OAI Image Edit Proxy, Speech Settings Handling, Import Query Data Usage (#10281)

* chor
- **2025-10-28** by github-actions[bot]: 🌍 i18n: Update translation.json with latest translations (#10274)

Co-authored-by: github-actions[bo
- **2025-10-28** by Daniel Paulus: 🎛️ feat: Custom Environment Variable Support to RAG API Helm Chart (#10245)

* Possibility to add ex

---

## 3. agents

**⭐ GitHub Stars:** 19224 | **🍴 Forks:** 2138 | **📅 创建时间:** 2025-07-24
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2025-10-28 22:06:42*
