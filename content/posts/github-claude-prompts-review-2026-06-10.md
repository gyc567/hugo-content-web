+++
date = "2026-06-10T22:40:27+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-06-10"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 139347 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均139347个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 212666 | **🍴 Forks:** 32656 | **📅 创建时间:** 2026-01-18
...
- **2026-06-10** by ECC Test: docs: update Greptile sponsor placement
- **2026-06-10** by Affaan Mustafa: feat(mcp): single-connector default set + connector policy (#2219)

Reduce the default .mcp.json to 
- **2026-06-10** by ECC Test: ci: remove copilot code-review surface

---

## 2. system-prompts-and-models-of-ai-tools

**⭐ GitHub Stars:** 139492 | **🍴 Forks:** 34589 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 65885 | **🍴 Forks:** 10746 | **📅 创建时间:** 2025-06-29
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-06-10 22:40:27*
