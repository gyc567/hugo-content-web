+++
date = "2026-06-28T22:26:39+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-06-28"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 145560 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均145560个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 223013 | **🍴 Forks:** 34156 | **📅 创建时间:** 2026-01-18
...
- **2026-06-25** by Affaan Mustafa: fix(clv2): harden registry writes and project deletion (#2294, #2297) (#2323)

Two security-priority
- **2026-06-25** by Gaurav Dubey: fix(clv2): escape $HOME before pgrep -f in migrate-homunculus.sh (#2339)

* fix(clv2): escape $HOME 
- **2026-06-25** by Affaan Mustafa: feat(control-pane): serve 3D agent-airspace viz + /api/proximity feed (#2320)

Adds the Layer 4 obse

---

## 2. system-prompts-and-models-of-ai-tools

**⭐ GitHub Stars:** 141275 | **🍴 Forks:** 34760 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 72394 | **🍴 Forks:** 8198 | **📅 创建时间:** 2026-04-28
...
- **2026-06-28** by xne998808-ai: feat(landing-page): add 5 design-agent alternative comparison pages (Stitch, Genspark, Figma Make, Q
- **2026-06-26** by Scarlett: feat(landing): first-touch attribution cookie for source→payment (#4820)

* feat(landing): first-tou
- **2026-06-26** by lefarcen: feat(daemon): native session resume across turns (codex / opencode / pi / AMR) (#4629)
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-06-28 22:26:39*
