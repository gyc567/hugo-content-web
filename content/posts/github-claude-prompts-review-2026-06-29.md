+++
date = "2026-06-29T22:27:51+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-06-29"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 145898 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均145898个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 223467 | **🍴 Forks:** 34209 | **📅 创建时间:** 2026-01-18
...
**⭐ GitHub Stars:** 141323 | **🍴 Forks:** 34758 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 72904 | **🍴 Forks:** 8277 | **📅 创建时间:** 2026-04-28
...
- **2026-06-29** by kokisanai: fix: replace expired Discord invite (#4849)

Co-authored-by: koki yanlai xu <koki@kokideMacBook-Air.
- **2026-06-29** by Ethan Guo: test(platform,sidecar-proto): cover proc-tree, stamp readers, ipc-path validation (#2406)

* test(si
- **2026-06-29** by Max Hsu: fix(plugins): add bundled Perplexity AI design-system plugin manifest (#4828) (#4833)
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-06-29 22:27:51*
