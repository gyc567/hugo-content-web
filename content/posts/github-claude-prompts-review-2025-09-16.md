+++
date = "2025-09-16T22:06:11+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2025-09-16"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 41898 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均41898个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 85530 | **🍴 Forks:** 23526 | **📅 创建时间:** 2025-03-05
...
- **2025-09-16** by Lucas Valbuena: Delete Lovable/Prompt.txt
- **2025-09-16** by Lucas Valbuena: Update System Prompt.txt
- **2025-09-16** by Lucas Valbuena: Update Decision-making prompt.txt

---

## 2. CL4R1T4S

**⭐ GitHub Stars:** 10140 | **🍴 Forks:** 2088 | **📅 创建时间:** 2025-03-04
...
**⭐ GitHub Stars:** 30026 | **🍴 Forks:** 5713 | **📅 创建时间:** 2023-02-12
...
- **2025-09-15** by Danny Avila: 📋 refactor: Agent Tool Permissions for File Upload Options (#9647)

- Added isEphemeralAgent functio
- **2025-09-15** by Dustin Healy: 👻 fix: Phantom MCP Tool Calls (#9634)

* fix: mcp tool calls no longer happening when unselected (wi
- **2025-09-14** by Danny Avila: 🔗 refactor: URL sanitization for MCP logging (#9632)
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2025-09-16 22:06:11*
