+++
date = "2026-06-25T22:34:52+08:00"
draft = false
title = "GitHub热门项目评测：Claude Code提示词项目深度分析 - 2026-06-25"
description = "每日精选GitHub上最热门的Claude Code prompts项目，深度分析其特点、优势和应用场景。GitHub 144992 stars，提示词工程领域热门开源项目深度评测。"
summary = "今日精选3个Claude Code提示词项目，平均144992个星标，涵盖prompt工程、开发工具、教程资源等多个方面。"
...
**⭐ GitHub Stars:** 221729 | **🍴 Forks:** 33946 | **📅 创建时间:** 2026-01-18
...
- **2026-06-21** by Affaan Mustafa: feat(layer4): live messages-table wiring for proximity triggers

Finishes the steer/transmit loop — 
- **2026-06-20** by Affaan Mustafa: feat(layer4): line-range channel + trigger firing

- Line precision: parse git diff --unified=0 into
- **2026-06-20** by Affaan Mustafa: docs(readme): add official-channel icons (Discord/Website/App/Guides) up top

Adds a clean badge row

---

## 2. system-prompts-and-models-of-ai-tools

**⭐ GitHub Stars:** 141162 | **🍴 Forks:** 34757 | **📅 创建时间:** 2025-03-05
...
**⭐ GitHub Stars:** 72086 | **🍴 Forks:** 7227 | **📅 创建时间:** 2026-04-03

**🔗 项目链接:** [safishamsi/graphify](https://github.com/safishamsi/graphify)
...
- **2026-06-25** by marketechniks: fix(hooks): match the real file extension in the Read|Glob hook (#1463)

The Read|Glob PreToolUse ho
- **2026-06-25** by safishamsi: fix(skill): state up front that no API key is required, with a non-subagent fallback (#1461)

Hermes
- **2026-06-25** by Michael Katsoulakis: feat(extract): WPF/XAML structural extraction with code-behind bridge (#1460)

Makes .xaml a first-c
...
*本文由自动化分析系统生成，数据来源于GitHub API，更新时间：2026-06-25 22:34:52*
